...
#qqx`ssh -o "StrictHostKeyChecking no" -i "MyKeyPair.pem" ubuntu@$public-dns-name` andthen .say;

my $proc = Proc::Async.new(:w, 'ssh', '-tt', '-o', "StrictHostKeyChecking no", '-i', "MyKeyPair.pem", "ubuntu@$public-dns-name");
